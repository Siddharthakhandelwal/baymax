...
class Baymax:
    ...
    def run(self):
        ...
        while True:
            ...
            # Initial greeting loop with timeout
            user_input = self.speech_to_text("Waiting for activation. say 'hi max'")

            if not user_input:
                self.text_to_speech("I'll wait for your greeting.")
                continue
            ...
            if "hello baymax" in user_input or "hi baymax" in user_input or "remix" in user_input or "max" in user_input or "hi" in user_input :
                ...
                if not query:
                    self.text_to_speech("I'll wait for your request.")
                    continue
                ...
                if "medicalsupport()" in action:
                    ...
                    self.check_emotion() # Reset counter for new valid inputs
                    return
